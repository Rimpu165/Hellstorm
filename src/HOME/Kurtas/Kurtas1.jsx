...
import { kurtasMen } from "./Kurtas"

const Kurtas1 = () => {
  const { id } = useParams();
  const shoe = kurtasMen.find((item) => item.id === Number(id));
...
<div className="md:w-1/2 p-6 flex flex-col justify-center">
          ...
          <Link to="/kurtas" className="text-blue-600 hover:underline text-sm">
            ← Back to Products
          </Link>
        </div>
      </div>
