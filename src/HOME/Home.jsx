      ...
      <div className="main">
        ...
        <div class=" text-center ">
          <h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">
            {" "}
            Discover amazing features and learn more about our services.
          </h1>
          ...
          <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="td p-6 bg-white rounded-lg shadow-lg text-center ">
              <p className="italic text-gray-600">
                "I love shopping here! The products are great, and shipping is
                always on time."
              </p>
            ...
            <div className="td p-6 bg-white rounded-lg shadow-lg text-center">
              <p className="italic text-gray-600">
                "The quality of the products is exceptional, and customer
            ...
            <div className="td p-6 bg-white rounded-lg shadow-lg text-center">
              <p className="italic text-gray-600">
                "I’m so happy with my purchase! Will definitely be shopping here
                again."
              </p>
