...
import { tommyProducts } from './Tomy';
...
const Tomy1 = () => {
    const {id}=useParams();
    const product=tommyProducts.find((product) => product.id === Number(id))
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-4 flex flex-col justify-center">
          ...
          <Link to="/Tomy" className="text-blue-600 hover:underline text-sm">
            ← Back to Products
          </Link>
        </div>
      </div>
