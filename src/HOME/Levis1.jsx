...
import { levisProducts } from './Levis';
...
const Levis1 = () => {
    const {id}=useParams();
    const pro=levisProducts.find((item) => item.id === Number(id))
    console.log("pro",pro);
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-6 flex flex-col justify-center">
          ...
          <span className="text-green-600 text-2xl font-semibold">₹{pro.price}</span>
          ...
          <Link to="/levis" className="text-blue-600 hover:underline text-sm">
            ← Back to Products
          </Link>
        </div>
      </div>
